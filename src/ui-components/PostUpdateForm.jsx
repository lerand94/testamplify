...
export default function PostUpdateForm(props) {
  ...
  const [linkFan, setLinkFan] = React.useState(initialValues.linkFan);
  ...
  const resetStateValues = () => {
    ...
    setLinkFan(cleanValues.linkFan);
      ...
      <TextField
        ...
        onChange={(e) => {
          ...
          if (onChange) {
            ...
            const result = onChange(modelFields);
            value = result?.linkFan ?? value;
          }
          if (errors.linkFan?.hasError) {
            runValidationTasks("linkFan", value);
          }
          setLinkFan(value);
        }}
        onBlur={() => runValidationTasks("linkFan", linkFan)}
        errorMessage={errors.linkFan?.errorMessage}
        hasError={errors.linkFan?.hasError}
        {...getOverrideProps(overrides, "linkFan")}
      ></TextField>
      <TextField
        label="Country"
        isRequired={false}
